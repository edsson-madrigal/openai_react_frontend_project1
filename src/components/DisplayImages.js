...
const DisplayImages = ({ imageUrls }) => {
  ...
  return (
    <>
      <div className="row">
        {imageUrls.length > 0 && (
          <h2 className="mt-4">Select Image to store</h2>
        )}
        {imageUrls.map((imageUrl, index) => (
          <div
            key={index}
            className={`col-md-4 image-container text-center ${
      ...
      {saveSuccess && (
        <div className="alert alert-success">Image saved successfully!</div>
      )}
          ...
          <div className="form-group row">
            <div className="col-sm-10 mt-2">
              <div className="form-floating input-group mb-3">
                ...
                <span className="input-group-text" id="image-extension">
                  .png
                </span>
              </div>
            </div>
